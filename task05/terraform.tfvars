...
app_services = {
  app1 = {
    name                  = "cmaz-12345678-mod5-app-01"
    app_service_plan_name = "cmaz-12345678-mod5-asp-01"
    rg_name               = "cmaz-12345678-mod5-rg-01"
    kind                  = "Windows"
    tier                  = "Standard"
    size                  = "S1"
  ...
  app2 = {
    name                  = "cmaz-12345678-mod5-app-02"
    app_service_plan_name = "cmaz-12345678-mod5-asp-02"
    rg_name               = "cmaz-12345678-mod5-rg-02"
    kind                  = "Windows"
    tier                  = "Standard"
    size                  = "S1"
...
app_service_plans = {
  app_service_plan1 = {
    name         = "cmaz-12345678-mod5-asp-01"
    rg_name      = "cmaz-12345678-mod5-rg-01"
    os_type      = "Windows"
    sku_name     = "P0v3"
    worker_count = 2
  ...
  app_service_plan2 = {
    name         = "cmaz-12345678-mod5-asp-02"
    rg_name      = "cmaz-12345678-mod5-rg-02"
    os_type      = "Windows"
    sku_name     = "P1v3"
    worker_count = 1
...
resource_groups = {
  rg_1 = {
    name        = "cmaz-12345678-mod5-rg-01"
    location    = "canadaeast"
    description = "Resource Group in East Canada"
  },
  rg_2 = {
    name        = "cmaz-12345678-mod5-rg-02"
    location    = "westus"
    description = "Resource Group in West US"
  },
  rg_3 = {
    name        = "cmaz-12345678-mod5-rg-03"
    location    = "centralus"
...
# Traffic Manager
traffic_manager = {
  profile_name           = "cmaz-12345678-mod5-traf"
  rg_name                = "cmaz-12345678-mod5-rg-03"
