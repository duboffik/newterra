...
resource_groups = {
  rg_1 = {
    name        = "cmaz-59602123-mod5-eastus-rg"
    location    = "eastus"
    description = "Resource group in East US Description"
  },
  rg_2 = {
    name        = "cmaz-59602123-mod5-westus-rg"
    location    = "westus"
    description = "Resource group in West US Description"
  },
  rg_3 = {
    name        = "cmaz-59602123-mod5-centralus-rg"
    location    = "centralus"
...
app_service_plans = {
  app_service_plan1 = {
    name         = "cmaz-59602123-mod5-eastus-asp"
    rg_name      = "cmaz-59602123-mod5-eastus-rg"
    os_type      = "Windows"
    sku_name     = "S1"
    worker_count = 2
  ...
  app_service_plan2 = {
    name         = "cmaz-59602123-mod5-westus-asp"
    rg_name      = "cmaz-59602123-mod5-westus-rg"
    os_type      = "Windows"
    sku_name     = "S1"
    worker_count = 1
...
app_services = {
  app1 = {
    name                  = "cmaz-59602123-mod5-eastus-app"
    app_service_plan_name = "cmaz-59602123-mod5-eastus-asp"
    rg_name               = "cmaz-59602123-mod5-eastus-rg"
    kind                  = "Windows"
    tier                  = "Standard"
    size                  = "S1"
  ...
  app2 = {
    name                  = "cmaz-59602123-mod5-westus-app"
    app_service_plan_name = "cmaz-59602123-mod5-westus-asp"
    rg_name               = "cmaz-59602123-mod5-westus-rg"
    kind                  = "Windows"
    tier                  = "Standard"
    size                  = "S1"
...
# Traffic Manager
traffic_manager = {
  profile_name           = "cmaz-59602123-mod5-centralus-traf"
  rg_name                = "cmaz-59602123-mod5-centralus-rg"
